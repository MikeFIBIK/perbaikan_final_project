    ...
    <div class="horizontalscroll">
      ...
      <a href="pemesanan">
        <div class="card linkbutton shadow hide">
          ...
          <div class="card-body">
            <h3>Paket Edukasi Bertani bersama para petani setempat</h3>
            <p>Rp 20.000</p>
          </div>
          <div class="overlay">
            <span class="detail">
              dalam paket ini anda datang ke tempat untuk bersantai dan mempelajari sesuatu oadfpoa apoidf aopdfupi apdfhapfapdfpi pidfpaosdifpi pop aiusd fao jk fiauheoiuadsa
            </span>
            <button class="pesan">
              Pesan
            </button>
        ...
        <div class="shadow" style="background-color:white; border-radius:20px; padding:3%;" height=100% width=100%>
          <div style="margin:1%">
            <a href="https://www.instagram.com/visitmulyaharja/">
              <img class="icon" src="assets/icon/instagram.png" style="vertical-align:middle" width=8%/>
          ...
          <div style="margin:1%">
            <a href="https://api.whatsapp.com/send/?phone=6281292840286&text&type=phone_number&app_absent=0">
              <img class="icon" src="assets/icon/whatsapp.png" style="vertical-align:middle" width=8%/>
          ...
          <div style="margin:1%">
            <a href="mailto:agroeduwisatamulyaharja@gmail.com">
              <img class="icon" src="assets/icon/email.png" style="vertical-align:middle" width=8%/>
          ...
          <div class="grid-jam">
            <div class="logo-jam">
              <img class="icon" src="assets/icon/clock.png" style="vertical-align:middle; width: 80%"/>
            </div>
